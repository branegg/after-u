...
import { Image, StyleSheet, Text, TouchableOpacity, View, StatusBar, KeyboardAvoidingView, TextInput, Alert } from 'react-native';
      ...
      <KeyboardAvoidingView style={styles.container} behavior='padding'>
        ...
        <Button
          ...
          onPress={() => {
            ...
            console.log(this.state.postcode.toString());
            this.state.postcode.length != 6
              ? Alert.alert('Please enter valid postcode')
              : this.state.postcodes.includes(this.state.postcode.toString())
