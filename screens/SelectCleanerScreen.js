...
import { Image, StyleSheet, Text, TouchableOpacity, View, StatusBar, TextInput, ImageBackground } from 'react-native';
  ...
  render() {
    return (
      <View style={styles.container}>
          ...
          {this.state.cleaners.length > 0 ? (
            this.state.cleaners.map(child => {
              ...
              return (
                ...
                >
                  <ImageBackground source={{ uri: cleaner.photo }} style={styles.photoWrapper}>
                    <Image
                      source={require('./../assets/images/cleanerActive.png')}
                      style={this.state.activeCleaner == key ? styles.cleanerActive : styles.cleanerInactive}
                    />
                  </ImageBackground>
                  <View style={styles.info}>
                    ...
                    <View style={styles.score}>
                      <Image source={require('./../assets/images/small-stars.png')} style={styles.stars} />
        ...
        <View style={this.state.activeCleaner != '' ? styles.buttonWrapper : styles.buttonInvisible}>
          <Button
            style={styles.button}
