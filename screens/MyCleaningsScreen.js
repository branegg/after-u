            ...
            <View style={styles.container}>
                <Modal isVisible={this.state.isModalVisible}>
                    <View style={styles.modalBackground}>
                        <View style={styles.modal}>
                            <Image
                                source={require("./../assets/images/eugene.png")}
                                style={styles.modalPhoto}
                            />
                            <Text style={styles.modalHeader}>HOW WOULD YOU RATE{"\n"}EUGENE?</Text>
                            <Text style={styles.modalText}>
                                He cleaned your apartment on{" "}
                                <Text style={styles.modalTextBold}>tuesday</Text>
                            </Text>
                            <ImageBackground
                ...
                <ScrollView style={styles.wrapperView} contentContainerStyle={styles.wrapper}>
                    {this.state.cleanings == null ? (
                        <View style={styles.noCleanings}>
                            ...
                            <Image
                                source={require("./../assets/images/personWithBg.png")}
                                style={styles.noCleaningsImage}
                            />
                            <Text style={styles.noCleaningsText}>
                                You can order your first{"\n"}cleaning with the button below
                            </Text>
                        </View>
                ...
                <View style={styles.buttonWrapper}>
                    <Button
                        ...
                        onPress={() => this.props.navigation.navigate("ChooseService")}
                        title="ORDER CLEANING"
                    />
                </View>
            </View>
        );
